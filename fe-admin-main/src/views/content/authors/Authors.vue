<template>
  <div class="p-8">
    <Component
      title="Author"
      :pageSize="authorStore.page_size"
      @clickAdd="() => (authorStore.createDialogIsOpen = true)"
      @clickRefresh="
        () => {
    ...
    <TableComponent
      :subjects="authorStore.authorData"
      :columns="ColumnNames"
      :isLoading="authorStore.isLoading"
      :row="AuthorRow"
      @clickDelete="
        (data: any) => {
    ...
    <Pagination
      :currentPage="authorStore.current_page"
      :totalItems="authorStore.totalItems"
      :totalPages="
        authorStore.totalItems % authorStore.page_size === 0
