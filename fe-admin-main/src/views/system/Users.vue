<template>
  <div class="p-8">
    <Component title="Users" :pageSize="userStore.page_size" :displayedPages="displayedPages"
      @clickAdd="() => (userStore.createDialogIsOpen = true)" @clickRefresh="
        () => {
    ...
    <TableComponent :subjects="userStore.userData" :columns="ColumnNames" :row="UserRow"
      :isLoading="userStore.isLoading" @clickDelete="
        (data: any) => {
