...
<template>
  <Dialog
    :open="userStore.updateDialogIsOpen"
    @update:open="
      (value : boolean) => {
  ...
  >
    <DialogContent>
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.username"
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.DisplayName"
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.FirstName"
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.LastName"
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.password"
      ...
      <div class="flex items-center gap-4">
        ...
        <Input
          v-model="userStore.selectedData.TierId"
          placeholder="Tier"
          type="number"
        />
      </div>
      ...
      <DialogFooter class="sm:justify-end">
        <Button
          variant="secondary"
          @click="userStore.updateDialogIsOpen = false"
        >
          Close
        </Button>
        <Button
