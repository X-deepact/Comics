...
<template>
  <Dialog :open="comicStore.createDialogIsOpen"
    ...
    <DialogContent class="overflow-y-scroll max-h-screen">
      ...
      <div class="flex items-center gap-4">
        ...
        <VueMultiselect v-model="comic.author" :options="authorStore.generalauthorData" :multiple="true"
          :close-on-select="false" placeholder="Select authors" label="name" track-by="name">
        </VueMultiselect>
      </div>
      <div class="flex items-center gap-4">
        <Label class="text-center w-1/4">Genre</Label>
        <VueMultiselect v-model="comic.genre" :options="genreStore.generalGenreData" :multiple="true"
          :close-on-select="false" placeholder="Select authors" label="name" track-by="name">
        </VueMultiselect>
      </div>
      <div class="flex items-center gap-4">
      ...
      <DialogFooter class="sm:justify-end">
        <Button variant="secondary" @click="comicStore.createDialogIsOpen = false">
          Close
        </Button>
